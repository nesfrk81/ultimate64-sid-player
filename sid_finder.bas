...
20 PRINT "SID FILE FINDER"
30 PRINT "==============="
40 PRINT
50 DIR$="USB0/MUSIC/HVSC/BESTOF"
60 PRINT "DIRECTORY: /";DIR$
70 PRINT
80 ON ERROR GOTO 600
90 REM Change directory
100 PRINT "CHANGING DIRECTORY..."
110 OPEN 15,11,15,"CD:/"+DIR$
120 CLOSE 15
130 PRINT "DONE"
140 PRINT "PRESS ANY KEY WHEN DRIVE LED STOPS"
...
570 END
600 PRINT "ERROR: ";ERR;" AT LINE ";ERL
610 ON ERROR GOTO 0
620 CLOSE 1
630 CLOSE 2
640 CLOSE 15
